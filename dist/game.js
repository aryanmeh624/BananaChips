...
`));
  ...
  scene("game1", () => {
    ...
    addLevel([
      ...
      width: 20,
      height: 20,
      "<": () => [sprite("wall_left"), solid(), area(), scale(0.5), "wall"],
      ">": () => [sprite("wall_right"), solid(), area(), scale(0.5), "wall"],
      "!": () => [sprite("wall_v"), solid(), area(), scale(0.5), "wall"],
      "=": () => [sprite("wall_h"), solid(), area(), scale(0.5), "wall"],
      "^": () => [sprite("wall_top"), solid(), area(), scale(0.5), "wall"],
      "#": () => [sprite("wall_down"), solid(), area(), scale(0.5), "wall"],
      "*": () => [sprite("oil"), solid(), area(), scale(0.5), "oil"],
      "$": () => [sprite("peel"), solid(), area(), scale(0.5), "peel"],
      "&": () => [sprite("door"), solid(), area(), scale(1, 1), "door"],
      "[": () => [sprite("raise"), solid(), area(), scale(2.5, 0.5), "raise"],
      "@": () => [sprite("purplebutton"), solid(), area(), scale(0.5), "btn"]
    });
    const mrb = add([
      sprite("banana"),
  ...
  scene("game2", () => {
    addLevel([
      ...
      "[": () => [sprite("raise"), solid(), area(), scale(2.5, 0.5), "raise"],
      "@": () => [sprite("purplebutton"), solid(), area(), scale(0.5), "btn"],
      "~": () => [sprite("sauce"), solid(), area(), scale(0.5), "sauce"]
    });
    const mrb = add([
      sprite("banana"),
      pos(650, 40),
